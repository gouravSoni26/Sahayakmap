    ...
    <div className="h-screen w-screen flex flex-col bg-slate-900 text-white overflow-hidden">
      ...
      <header className="flex items-center justify-between px-4 py-2 bg-slate-800 border-b border-slate-700 shrink-0">
        <div className="flex items-center gap-3">
          <button onClick={() => setPanelOpen(o => !o)} className="p-1 hover:bg-slate-700 rounded">
            <Menu size={20} />
          </button>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {panelOpen && (
          <aside className="w-80 xl:w-96 flex flex-col bg-slate-800 border-l border-slate-700 overflow-hidden shrink-0">
            {/* AI Situation Brief */}
            <SituationPanel />
